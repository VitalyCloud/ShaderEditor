...
void DrawInputSettingsView(OpenGL::ShaderDataType type, ImGuiInputSettings* settings) {
...
bool DrawInputFloat(float* data, const ImGuiInputSettings* settings, int count) {
...
bool DrawInputInt(int* data, const ImGuiInputSettings* settings, int count) {
    assert(count > 0 && count < 5);
    assert(settings != nullptr);
    switch (count) {
        case 1:
...
bool DrawInputMat(float* data, const ImGuiInputSettings* settings, int count) {
